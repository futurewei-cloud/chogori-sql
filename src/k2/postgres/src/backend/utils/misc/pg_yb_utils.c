...
YBCPgDataTypeToStr(YBCPgDataType yb_type) {
	switch (yb_type) {
		...
		case K2SQL_DATA_TYPE_VARINT: return "VARINT";
		case K2SQL_DATA_TYPE_INET: return "INET";
		case K2SQL_DATA_TYPE_LIST: return "LIST";
		case K2SQL_DATA_TYPE_MAP: return "MAP";
		case K2SQL_DATA_TYPE_SET: return "SET";
		case K2SQL_DATA_TYPE_UUID: return "UUID";
		case K2SQL_DATA_TYPE_TIMEUUID: return "TIMEUUID";
		case K2SQL_DATA_TYPE_TUPLE: return "TUPLE";
		case K2SQL_DATA_TYPE_TYPEARGS: return "TYPEARGS";
		case K2SQL_DATA_TYPE_USER_DEFINED_TYPE: return "USER_DEFINED_TYPE";
		case K2SQL_DATA_TYPE_FROZEN: return "FROZEN";
		case K2SQL_DATA_TYPE_DATE: return "DATE";
		case K2SQL_DATA_TYPE_TIME: return "TIME";
		case K2SQL_DATA_TYPE_JSONB: return "JSONB";
