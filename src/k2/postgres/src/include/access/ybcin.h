...
/*
 * external entry points for K2PG indexes in ybcin.c
 */
...
extern bool ybcininsert(Relation rel, Datum *values, bool *isnull, Datum k2pgctid, Relation heapRel,
						IndexUniqueCheck checkUnique, struct IndexInfo *indexInfo);
extern void ybcindelete(Relation rel, Datum *values, bool *isnull, Datum k2pgctid, Relation heapRel,
